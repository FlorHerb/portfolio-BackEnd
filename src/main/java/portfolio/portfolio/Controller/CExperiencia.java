...
import portfolio.portfolio.Dto.DtoExperiencia;
import portfolio.portfolio.Entity.Experiencia;
import portfolio.portfolio.Security.Controller.Mensaje;
import portfolio.portfolio.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody DtoExperiencia dtoexp){      
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getDescripcionE()
                                  ,dtoexp.getImg(),dtoexp.getFecha_inicio(),dtoexp.getFecha_fin()
                                  ,dtoexp.getEmpleador());
